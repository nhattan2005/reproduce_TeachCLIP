...
class MSVD_DataLoader(Dataset):
    ...
    def __init__(
        ...
        caption_file = os.path.join(self.data_path, "raw-captions.pkl") #  msrvttpretrain_1masksaliencynoveltytoken.pkl raw-captions.pkl msvdpretrain_recover1masksaliencynoveltytoken.pkl msvdpretrain_1masksaliencynoveltytoken.pkl
