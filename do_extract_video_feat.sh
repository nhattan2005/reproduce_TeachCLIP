...
python -m torch.distributed.launch extract_feat.py --datatype video \
    --local_rank=3 --num_thread_reader=8 --batch_size=10 \
    ...
    --init_model "/home/nhattanpro444/Project/TeachCLIP/reproduce_TeachCLIP/data/teacher_checkpoints/$model_name/best_model.bin" \
