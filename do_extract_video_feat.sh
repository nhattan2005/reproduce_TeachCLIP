...
python -m torch.distributed.launch --nproc_per_node=1 extract_feat.py \
    --datatype video \
    --local_rank=0 \
    --num_thread_reader 8 \
    --batch_size 100 \
    ...
    --init_model "/kaggle/input/teachclipdata-update1/data/teacher_checkpoints/$model_name/best_model.bin" \
    --max_frames 12 \
    --max_words 32 \
    --feature_framerate 1 \
    --slice_framepos 2 \
