...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, text_embeds, video_embeds):
        ...
        # num_vids x num_texts x num_frames
        attention_weights_out = attention_weights.squeeze().permute(0,2,1)
        # num_vids x num_frames
        attention_weights_out = torch.diagonal(attention_weights_out).T
        
        return o, attention_weights_out
...
class Transformer(nn.Module):
    ...
    def forward(self, text_embeds, video_embeds):
        ...
        # num_vids x num_texts x embed_dim
        attn_out, attention_weights_out = self.cross_attn(text_embeds, video_embeds)
        ...
        return out, attention_weights_out
